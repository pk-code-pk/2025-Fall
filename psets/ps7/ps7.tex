...
\end{tikzpicture}
        ...
        Show how to assign weights to the patients $p_0,\ldots,p_2$ so that there is no matching that simultaneously maximizes $w(M)$ and $|M|$ over all matchings $M$ that satisfy the paired donor-patient constraint.
